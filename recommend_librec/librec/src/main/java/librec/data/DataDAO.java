...
public class DataDAO {
	...
	public Table<Integer, Integer, Double> readDataTable(String path,int[] cols) throws Exception {

		Logs.info(String.format("Dataset: %s", Strings.last(path, 38)));
	...
	public SparseMatrix[] readData(int[] cols, double binThold) throws Exception {
		...
		Logs.debug("With Specs: {Users, {}} = {{}, {}, {}},{}", (isItemAsUser ? "Users, Links"
				: "Items, Ratings"), numRows, numCols, numRatings,  dateRange);
