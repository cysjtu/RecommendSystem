...
public class CachedUserKNN extends Recommender {
	...
	public CachedUserKNN(SparseMatrix trainMatrix, SparseMatrix testMatrix, int fold) {
	...
	protected double predict(int u, int j) {
		...
		SparseVector dv=new SparseVector(numUsers);
